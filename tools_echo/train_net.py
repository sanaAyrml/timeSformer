...
def train_epoch(
    ...
    for cur_iter,(inputs,labels,(ef,large_frame, small_frame, large_trace, small_trace), meta) in enumerate(train_loader):
...
def eval_epoch(val_loader, model, val_meter, cur_epoch, cfg, writer=None):
    ...
    for cur_iter,(inputs,labels,(ef,large_frame, small_frame, large_trace, small_trace), meta) in enumerate(val_loader):
        if cfg.NUM_GPUS:
